import 'package:f_hive_bloc/model/task.dart';
...
class TodoService {
  ...
  Future<void> init() async {
    ...
    await _tasks.add(Task('test1', 'task1-1', false));
    await _tasks.add(Task('test1', 'task1-2', true));
    await _tasks.add(Task('test1', 'task1-3', false));
    await _tasks.add(Task('test2', 'task2-1', false));
  }
